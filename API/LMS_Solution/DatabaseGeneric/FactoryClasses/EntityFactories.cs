...
using LMS.Application.LLBL.EntityClasses;
using LMS.Application.LLBL.HelperClasses;
using LMS.Application.LLBL.RelationClasses;
using SD.LLBLGen.Pro.ORMSupportClasses;

namespace LMS.Application.LLBL.FactoryClasses
{
	...
	{
		/// <summary>Gets the factory of the Entity type with the LMS.Application.LLBL.EntityType value passed in</summary>
